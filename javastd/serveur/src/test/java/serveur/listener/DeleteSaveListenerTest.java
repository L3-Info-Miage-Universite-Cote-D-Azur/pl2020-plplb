...
public class DeleteSaveListenerTest {
    private DeleteSaveListener deleteSaveListener;
    ...
    public void init(){
        ...
        deleteSaveListener = new DeleteSaveListener(linkClientSocket,courseDataBase);
    }
    ...
    public void onDataTest() throws Exception {
        ...
        deleteSaveListener.onData(socketIOClient,"nom",null);
        ...
        Mockito.verify(courseDataBase,times(1)).deleteSave(anyString(),anyString());
    }
}
